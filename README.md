...
- **Console** (1 bouton gris, accent vert quand active) — *Console* : afficher / masquer la console des messages (l'overlay `#messageBoard`, texte vert transparent sous la toolbar où sont loggés les événements). La préférence est mémorisée dans `localStorage` et restaurée au rechargement.
