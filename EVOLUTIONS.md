...
- ajouter un mode de sélection du plan actif basé sur l'affichage de chaque plan différent avec simulation d'affichage 3D de ces plans ; chaque plan est incliné autour d'un axe vertical virtuel pour donner à l'utilisateur une impression de décalage de chaque plan ; la position du pointeur sur l'horizontal fait varier l'inclinaison des plans et met en valeur un plan à la fois permettant de le sélectionner ; l'analogie la plus proche est la représentation sous la forme d'un kiosque de sélection
